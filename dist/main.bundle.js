...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_app_app__ = __webpack_require__("../../../../../src/app/components/_app/app.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_templates_header__ = __webpack_require__("../../../../../src/app/components/_templates/header.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_templates_footer__ = __webpack_require__("../../../../../src/app/components/_templates/footer.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_templates_gravity__ = __webpack_require__("../../../../../src/app/components/_templates/gravity.ts");
...
var appRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_11__components_home_home__["a" /* HomeComponent */] }
];
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_10__components_app_app__["a" /* AppComponent */],
                __WEBPACK_IMPORTED_MODULE_12__components_templates_header__["a" /* HeaderComponent */],
                __WEBPACK_IMPORTED_MODULE_13__components_templates_footer__["a" /* FooterComponent */],
                __WEBPACK_IMPORTED_MODULE_14__components_templates_gravity__["a" /* GravityComponent */],
                __WEBPACK_IMPORTED_MODULE_11__components_home_home__["b" /* SafePipe */],
                __WEBPACK_IMPORTED_MODULE_11__components_home_home__["a" /* HomeComponent */]
            ],
            bootstrap: [__WEBPACK_IMPORTED_MODULE_10__components_app_app__["a" /* AppComponent */]]
        })
    ], AppModule);
    return AppModule;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__datamodels_highlightItem__ = __webpack_require__("../../../../../src/app/datamodels/highlightItem.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__datamodels_mediaItem__ = __webpack_require__("../../../../../src/app/datamodels/mediaItem.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__datamodels_newsItem__ = __webpack_require__("../../../../../src/app/datamodels/newsItem.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__datamodels_artistItem__ = __webpack_require__("../../../../../src/app/datamodels/artistItem.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent() {
        this.carouselItems = [
            new __WEBPACK_IMPORTED_MODULE_3__datamodels_highlightItem__["a" /* HighlightItem */]("Future Release: 'CMOG'", 'CMOG, the album will be released on 11/28 via all platforms', 'assets/images/demo/CMOG.jpeg'),
            new __WEBPACK_IMPORTED_MODULE_3__datamodels_highlightItem__["a" /* HighlightItem */]("Basement Tuesdays Performance", "Gandhi Ali will be performing this tuesday at Pure Lounge's 'Basement Tuesdays'", 'assets/images/demo/IMG2.jpg'),
            new __WEBPACK_IMPORTED_MODULE_3__datamodels_highlightItem__["a" /* HighlightItem */]("Panda's Play House II: A Trippy Affair", 'Come checkout Gandhi Ali at MilkBoy Arthouse out in College Park, MD. 12/1', 'assets/images/demo/panda1.jpeg')
        ];
        this.spotlightItems = [
            new __WEBPACK_IMPORTED_MODULE_4__datamodels_mediaItem__["a" /* MediaItem */]('Chocolate City (Teaser)', 'Gandhi Ali', 'LUHaEGtSHmc'),
            new __WEBPACK_IMPORTED_MODULE_4__datamodels_mediaItem__["a" /* MediaItem */]('Freestyle', 'Gandhi Ali', 'BlCM6L4Gbss'),
            new __WEBPACK_IMPORTED_MODULE_4__datamodels_mediaItem__["a" /* MediaItem */]('Lucky', 'Gandhi Ali', 'DJGjXKln8L8'),
            new __WEBPACK_IMPORTED_MODULE_4__datamodels_mediaItem__["a" /* MediaItem */]('Chocolate City (Teaser)', 'Gandhi Ali', 'LUHaEGtSHmc'),
            new __WEBPACK_IMPORTED_MODULE_4__datamodels_mediaItem__["a" /* MediaItem */]('Chocolate City (Teaser)', 'Test Artist', 'LUHaEGtSHmc')
        ];
        this.newsItems = [
            new __WEBPACK_IMPORTED_MODULE_5__datamodels_newsItem__["a" /* NewsItem */]('CMOG Releasing Soon!', 'assets/images/demo/CMOG.jpeg', ''),
            new __WEBPACK_IMPORTED_MODULE_5__datamodels_newsItem__["a" /* NewsItem */]('Tackover Tuesday Performance: Gandhi Ali', 'assets/images/demo/IMG2.jpg', ''),
            new __WEBPACK_IMPORTED_MODULE_5__datamodels_newsItem__["a" /* NewsItem */]('Gandhi Ali Performing at Panda Play', 'assets/images/demo/panda1.jpeg', ''),
            new __WEBPACK_IMPORTED_MODULE_5__datamodels_newsItem__["a" /* NewsItem */]('CMOG Releasing Soon!', 'assets/images/demo/CMOG.jpeg', ''),
            new __WEBPACK_IMPORTED_MODULE_5__datamodels_newsItem__["a" /* NewsItem */]('Tackover Tuesday Performance: Gandhi Ali', 'assets/images/demo/IMG2.jpg', ''),
            new __WEBPACK_IMPORTED_MODULE_5__datamodels_newsItem__["a" /* NewsItem */]('Gandhi Ali Performing at Panda Play', 'assets/images/demo/panda1.jpeg', '')
        ];
        this.featuredArtist = new __WEBPACK_IMPORTED_MODULE_6__datamodels_artistItem__["a" /* ArtistItem */]("Gandhi Ali", "As Mind Control's first solo artist we have grown around him as an artist.  Get to know Gandhi and see where you can check him out next.", "assets/images/demo/GandhiAli-banner.jpg");
    }
...
var ArtistItem = /** @class */ (function () {
    function ArtistItem(Name, Bio, BannerImg) {
        this.name = Name;
        this.bio = Bio;
...
/***/ "../../../../../src/app/datamodels/highlightItem.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HighlightItem; });
var HighlightItem = /** @class */ (function () {
    function HighlightItem(Title, TextStr, Image) {
        this.image = Image;
        this.title = Title;
        this.text = TextStr;
    }
...
/***/ "../../../../../src/app/datamodels/mediaItem.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MediaItem; });
var MediaItem = /** @class */ (function () {
    function MediaItem(Title, Artist, Url) {
        this.url = Url;
        this.title = Title;
        this.artist = Artist;
    }
    MediaItem.prototype.returnTypeUrl = function (type) {
        var retUrl = (type == "video" ? "https://www.youtube.com/embed/" + this.url : "http://img.youtube.com/vi/" + this.url + "/default.jpg");
        return retUrl;
    };
    return MediaItem;
}());
